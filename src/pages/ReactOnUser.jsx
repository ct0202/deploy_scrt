            ...
            <div className="relative h-[100%]">
                <div className="w-[100%] pt-[100px] pb-[80px] flex flex-col !items-center">
                    ...
                    <div className="z-0 w-full flex justify-center items-center flex-col">
                        ...
                        <div className='fixed z-[10] flex items-center flex-row w-[343px] justify-between'>
                            <img src='/icons/button-dislike-on-superlike.svg' />
                            <img src='/icons/button-like-on-superlike.svg' />
                        </div>
                    </div>
                    {openToast && (
